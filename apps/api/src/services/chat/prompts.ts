...
export const TOOL_GUIDANCE = [
	...
	'It renders self-contained HTML in a locked-down frame, so embed every image',
	'as a data: URI and never reference a remote URL. It becomes a picture on',
	'DOCX export, so never use it for ordinary prose.',
	'Pick its "fit" deliberately. A whole-sheet design - flyer, poster,',
	'one-pager - is fit "page": call get_page_setup first for the sheet size in',
	'pixels, make the root element width:100% height:100%, and keep everything',
	'inside it, because content taller than the sheet is cut off at the page',
	'edge rather than scaled down. Anything smaller that belongs in the middle',
	'of running text is fit "embed" with a height in pixels.',
